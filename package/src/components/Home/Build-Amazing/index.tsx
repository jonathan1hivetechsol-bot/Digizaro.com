          ...
          <div className='grid lg:grid-cols-2 grid-cols-1 items-center'>
            <div
              ...
              <h2 className='text-secondary dark:text-white max-w-420 pb-8'>
                Professional SEO Services & Web Development Solutions by Digizaro
              </h2>
              <p className='text-base font-normal text-SlateBlue dark:text-darktext max-w-408'>
                Boost your online presence with our expert SEO services and custom web development solutions tailored for your business success.
              </p>
