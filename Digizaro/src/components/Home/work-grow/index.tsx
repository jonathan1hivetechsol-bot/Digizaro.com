          ...
          <div className='grid md:grid-cols-2 grid-cols-1 gap-10'>
            <div className=''>
              <h2 className='text-secondary dark:text-white max-w-446'>
                Professional SEO & Web Development Services by Digizaro
              </h2>
              <p className='text-SlateBlue dark:text-darktext text-base font-normal py-9 max-w-408'>
                We help businesses grow their online presence with expert SEO optimization and custom web development solutions that drive real results.
              </p>
              <div className=''>
